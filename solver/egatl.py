...
def summarize_recovery(
    ...
    return {
        ...
        "qzw_chern_pre": qwz_chern_pre,
        "qzw_chern_post": qwz_chern_post,
        "qzw_chern_delta": qwz_chern_post - qwz_chern_pre,
        "bott_pre": bott_pre,
        "bott_post": bott_post,
        "bott_delta": bott_post - bott_pre,
        "bott_integer_error_pre": bott_int_err_pre,
        "bott_integer_error_post": bott_int_err_post,
        "qzw_u_eff_pre": u_eff_pre,
        "qzw_u_eff_post": u_eff_post,
        "qzw_gap_pre": gap_pre,
        "qzw_gap_post": gap_post,
